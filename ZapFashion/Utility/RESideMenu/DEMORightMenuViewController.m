...
+(DEMORightMenuViewController *)shareInstance {
    static DEMORightMenuViewController *objLeftMenu = nil;
...
- (void)viewDidLoad
{
 ...
 //   
    self.tableView = ({
        UITableView *tableView = [[UITableView alloc] initWithFrame:CGRectMake((self.view.frame.size.width*3)/8, 0 ,250.0 ,self.view.frame.size.height) style:UITableViewStylePlain];
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    //    {
    NSLog(@"%@",self);
    imageView = [[UIImageView alloc] initWithFrame:CGRectMake(60, 30, 60, 60)];
    lblName=[[UILabel alloc]initWithFrame:CGRectMake(30, 90, 120, 60)];
    lblName.numberOfLines = 0;
    
    whiteDivider = [[UIView alloc] initWithFrame:CGRectMake(0, 145, self.tableView.frame.size.width, 1)];
...
-(void) setLeftmenuItems:(NSInteger)tag
{
 UIStoryboard *storyboard = [UIStoryboard storyboardWithName: @"Main" bundle:nil];
      ...
      else if ([[[appSharedObj.ArrMenuItems objectAtIndex:tag] valueForKey:@"is_cms"] isEqualToString:@"1"])
    {
        ...
        [mainNavigation pushViewController:newView animated:NO];
    ...
    else if ([[[appSharedObj.ArrMenuItems objectAtIndex:tag] valueForKey:@"child"]  isEqualToString:@"1"])
    {
        ...
        UINavigationController *mainNavigation = (UINavigationController *) [self.sideMenuViewController contentViewController];
        [mainNavigation pushViewController:ObjSettingsVC animated:NO];
        [self.sideMenuViewController hideMenuViewController];
    }
    else
    {
    ...
    switch (item) {
        case 0: {
            ...
            [mainNavigation pushViewController:ObjViewController animated:NO];
            [self.sideMenuViewController hideMenuViewController];
        ...
        case 1: {
            ...
            [mainNavigation pushViewController:ObjCategoryTblVC animated:NO];
            [self.sideMenuViewController hideMenuViewController];
        ...
        case 2: {
            ...
            [mainNavigation pushViewController:ObjAccountVC animated:NO];
            [self.sideMenuViewController hideMenuViewController];
        ...
        case 5: {
            ...
            [mainNavigation pushViewController:ObjNotificationHistoryVC animated:NO];
            [self.sideMenuViewController hideMenuViewController];
